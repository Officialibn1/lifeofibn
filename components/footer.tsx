...
export function Footer() {
	...
	return (
		<footer className='relative w-full px-6 sm:px-8 pt-12 sm:pt-16 border-t border-border '>
			...
			<h1 className='text-6xl text-center font-bold md:text-8xl lg:text-[128px] xl:text-[190px] absolute -bottom-20 md:-bottom-36 lg:-bottom-44 xl:-bottom-64 left-0 w-full opacity-5'>
				LIFE OF IBN
			</h1>
		</footer>
	);
